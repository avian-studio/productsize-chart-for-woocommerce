...
<div id="productsize-chart-meta-fields" class="chart-0"> 
	...
	<div id="field">
		<div class="field-title"><h4><?php esc_html_e( 'Image Position', $this->plugin_name ); ?></h4></div> 
		<div class="field-description"><?php esc_html_e( 'Primary chart mage position', $this->plugin_name ); ?></div>
		<div class="field-item">
			<select name="primary-image-position" id="primary-image-position">
				<option value="left" <?php selected( $chart_img_position, 'left' ); ?>><?php esc_html_e( 'Left', $this->plugin_name ); ?></option>
				<option value="right" <?php selected( $chart_img_position, 'right' ); ?>><?php esc_html_e( 'Right', $this->plugin_name ); ?></option>
			</select>
		</div>
	</div>
	<div id="field">
		<div class="field-title"><h4><?php esc_html_e( 'Title Color', $this->plugin_name ); ?></h4></div> 
		<div class="field-description"><?php esc_html_e( 'Pick text color for the chart text', $this->plugin_name ); ?></div>
		<div class="field-item"><input type="text" id="title-color" name="title-color" value="<?php echo esc_attr( $title_color ); ?>" /></div>
	</div>
	<div id="field">
		<div class="field-title"><h4><?php esc_html_e( 'Text Color', $this->plugin_name ); ?></h4></div> 
		<div class="field-description"><?php esc_html_e( 'Pick text color for the chart text', $this->plugin_name ); ?></div>
		<div class="field-item"><input type="text" id="text-color" name="text-color" value="<?php echo esc_attr( $text_color ); ?>" /></div>
	</div>
	<div id="field">
		<div class="field-title"><h4><?php esc_html_e( 'Overlay Color', $this->plugin_name ); ?></h4></div> 
		<div class="field-description"><?php esc_html_e( 'Pick overlay background color for modal', $this->plugin_name ); ?></div>
		<div class="field-item">
	...
	<div id="field">
		...
		<div class="field-description"><?php esc_html_e( 'Chart Table Styles (Default Style 1)', $this->plugin_name ); ?></div>
		<div class="field-item">
			<select name="table-style" id="table-style">
				<option value="style-1" <?php selected( $table_style, 'style-1' ); ?>><?php esc_html_e( 'Style 1', $this->plugin_name ); ?></option>
				<option value="style-2" <?php selected( $table_style, 'style-2' ); ?>><?php esc_html_e( 'Style 2', $this->plugin_name ); ?></option>
			</select>
		</div>
	</div>
	<div id="field">
		<div class="field-title"><h4><?php esc_html_e( 'Padding (e.g. 10px)', $this->plugin_name ); ?></h4></div> 
		<div class="field-description"><?php esc_html_e( 'Pick overlay background color for modal', $this->plugin_name ); ?></div>
		<div class="field-item">
	...
	<div id="field">
		...
		<div class="field-item">
			<select name="position" id="position">
				<option value="tab" <?php selected( $chart_position, 'tab' ); ?>><?php esc_html_e( 'Additional Tab', $this->plugin_name ); ?></option>
				<option value="popup" <?php selected( $chart_position, 'popup' ); ?>><?php esc_html_e( 'Modal Pop Up', $this->plugin_name ); ?></option>
			</select>
		</div>
	</div>
	<div style="clear:both"></div>
	<div id="field" class="tab-or-modal" <?php echo $chart_position == 'tab' ? "style='display:none;'" : ''; ?>>
		<div class="field-title"><h4><?php esc_html_e( 'Chart Popup Button Position', $this->plugin_name ); ?></h4></div> 
		<div class="field-description"><?php esc_html_e( 'Select where the pop up button displays', $this->plugin_name ); ?></div>
		<div class="field-item">
			<select name="button-position" id="button-position">
				<option value="before-summary-text" <?php selected( $button_position, 'before-summary-text' ); ?>><?php esc_html_e( 'Before Summary Text', $this->plugin_name ); ?></option>
				<option  value="after-add-to-cart" <?php selected( $button_position, 'after-add-to-cart' ); ?>><?php esc_html_e( 'After Add to Cart', $this->plugin_name ); ?></option>
				<option value="before-add-to-cart" <?php selected( $button_position, 'before-add-to-cart' ); ?>><?php esc_html_e( 'Before Add to Cart', $this->plugin_name ); ?></option>
				<option value="after-product-meta" <?php selected( $button_position, 'after-product-meta' ); ?>><?php esc_html_e( 'After Product Meta', $this->plugin_name ); ?></option>
			</select>
		</div>
	</div>
	<div id="field">
