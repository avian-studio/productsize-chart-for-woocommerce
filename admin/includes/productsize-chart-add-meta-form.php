...
<div id="productsize-chart-meta-fields" class="chart-1"> 
	<div class="title-wrap">
		<h2><?php esc_html_e( 'Chart 1', $this->plugin_name ); ?></h2>
	</div>
	<div id="field">
		<div class="field-title"><h4><?php esc_html_e( 'Chart Title', $this->plugin_name ); ?></h4></div> 
		<div class="field-description"><?php esc_html_e( 'Add/Edit chart title below', $this->plugin_name ); ?></div>
		<div class="field-item"><input type="text" id="chart-title-1" name="chart-title-1" value="<?php echo esc_attr( $chart1_title ); ?>" /></div>
	</div>

	<div id="field">
		<div class="field-title"><h4><?php esc_html_e( 'Chart Image', $this->plugin_name ); ?></h4></div> 
		<div class="field-description"><?php esc_html_e( 'Add/Edit chart image below', $this->plugin_name ); ?></div>
		...
		<div class="field-item"><input type="button" id="meta-image-button-1" class="button" value="<?php esc_html_e( 'Upload', $this->plugin_name ); ?>" /></div>
	</div>

	<div id="field">
		<div class="field-title"><h4><?php esc_html_e( 'Image Position', $this->plugin_name ); ?></h4></div> 
		<div class="field-description"><?php esc_html_e( 'Primary chart image position', $this->plugin_name ); ?></div>
		<div class="field-item">
			<select name="image-position-1" id="image-position-1">
				<option value="left" <?php selected( $chart1_img_position, 'left' ); ?>><?php esc_html_e( 'Left', $this->plugin_name ); ?></option>
				<option value="right" <?php selected( $chart1_img_position, 'rightt' ); ?>><?php esc_html_e( 'Right', $this->plugin_name ); ?></option>
			</select>
		</div>
	</div>

	<div id="field">
		<div class="field-title"><h4><?php esc_html_e( 'Content', $this->plugin_name ); ?></h4></div> 
		<div class="field-description"><?php esc_html_e( 'Chart 1 content', $this->plugin_name ); ?></div>
		<div class="field-item">
...
<div id="productsize-chart-meta-fields" class="chart-2"> 
	<div class="title-wrap"><h2><?php esc_html_e( 'Chart 2', $this->plugin_name ); ?></h2></div>
	<div id="field">
		<div class="field-title"><h4><?php esc_html_e( 'Chart Title', $this->plugin_name ); ?></h4></div> 
		<div class="field-description"><?php esc_html_e( 'Add/Edit chart title below', $this->plugin_name ); ?></div>
	...
	<div id="field">
		...
		<div id="field-image">
		 ...
		 <div class="field-item"><input type="button" id="meta-image-button-2" class="button" value="<?php esc_html_e( 'Upload', $this->plugin_name ); ?>" /></div>
	</div>
	...
	<div id="field">
		...
		<div class="field-item">
			<select name="image-position-2" id="image-position-2">
				<option value="left" <?php selected( $chart2_img_position, 'left' ); ?>><?php esc_html_e( 'Left', $this->plugin_name ); ?></option>
				<option value="right" <?php selected( $chart2_img_position, 'right' ); ?>><?php esc_html_e( 'Right', $this->plugin_name ); ?></option>
			</select>
		</div>
	</div>
	...
	<div id="field">
		<div class="field-title"><h4><?php esc_html_e( 'Content', $this->plugin_name ); ?></h4></div> 
		<div class="field-description"><?php esc_html_e( 'Chart 2 content', $this->plugin_name ); ?></div>
		<div class="field-item">
