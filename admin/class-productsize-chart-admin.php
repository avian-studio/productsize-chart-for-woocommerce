...
public function  productsize_chart_menu(){
	add_submenu_page('edit.php?post_type=chart', esc_html__( 'NC Plugins', $this->plugin_name ), esc_html__( 'Settings', $this->plugin_name ), 'manage_options', 'productsize_chart', array( $this, 'productsize_chart_settings_form') );
